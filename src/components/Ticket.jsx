    ...
    <article className="ticket">
      ...
      <div className="ticket__routes">
        <div className="ticket__departure">
          ...
          <div className="ticket__route">
            <span className="ticket__time">
              {getTime(item.departure.to.datetime)}
            </span>
        ...
        {item.arrival ? (
          <div className="ticket__arrival">
            <div className="ticket__route">
              <span className="ticket__time">
                {getTime(item.arrival.from.datetime)}
              </span>
              <span className="ticket__city">
            ...
            <div className="ticket__route">
              <span className="ticket__time">
                {getTime(item.arrival.to.datetime)}
              </span>
      ...
      <div className="ticket__seats">
        {item.departure.have_first_class ? (
          <TicketSeat
            ...
            price={item.departure.price_info.first.bottom_price}
          />
        ) : (
          ""
        )}
        {item.departure.have_second_class ? (
          <TicketSeat
            ...
            price={item.departure.price_info.second.bottom_price}
          />
        ) : (
          ""
        )}
        {item.departure.have_third_class ? (
          <TicketSeat
            ...
            price={item.departure.price_info.third.bottom_price}
          />
        ) : (
          ""
        )}
        {item.departure.have_fourth_class ? (
          <TicketSeat
            ...
            price={item.departure.price_info.fourth.bottom_price}
          />
        ) : (
          ""
        )}
        <svg
          className="ticket__advantages-svg"
          width="92"
          height="20"
          viewBox="0 0 92 20"
          fill="none"
